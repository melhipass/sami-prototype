      ...
      {selectedRecordingIndex !== null ? (
        ...
        (() => {
          ...
          return (
            <>
              {/* Top black bar */}
              <div className="bg-app-surface py-4 flex items-center justify-between px-6">
                <button
                  onClick={() => {
                ...
                <span className="text-app-content text-base font-medium">
                  {showArchivedSection
                    ? (() => {
              ...
              {/* Video display area */}
              <div className="bg-app-surface relative flex items-center justify-center gap-6 py-4" style={{ height: '80vh' }}>
                {/* Video image wrapper - 4:3 aspect ratio */}
                <div className="relative h-full" style={{ aspectRatio: '4/3' }}>
                  {isDownloadingRecording ? (
                    /* Downloading state */
                    <div
                      className="w-full h-full bg-app-surface flex flex-col items-center justify-center gap-6 cursor-pointer"
                      onClick={() => {
                    ...
                    >
                      {isRecordingMissing ? (
                        ...
                        <>
                          ...
                          <h2 className="text-2xl text-app-content font-semibold">Recording no longer available</h2>
                        </>
                      ) : isWaitingForCamera ? (
                        <>
                          <h2 className="text-3xl text-app-content font-medium">Waiting for Camera...</h2>
                          <h3 className="text-xl text-app-content-faint">Will retry automatically</h3>
                        </>
                      ) : (
                        <>
                          <h2 className="text-3xl text-app-content font-medium">Downloading...</h2>

                          <h3 className="text-xl text-app-content-faint">Downloading from Camera</h3>

                          <p className="text-lg text-app-quiet">
                            {downloadProgress}%
                          </p>

                          {/* Progress Bar */}
                          <div className="w-full max-w-xs bg-app-card rounded-full h-3 overflow-hidden border border-[#FCEAAD]/30">
                            <div
                          ...
                          <p className="text-sm text-app-content-faint mt-2">
                      ...
                      <button
                        ...
                        className={`p-3 rounded-full transition-all backdrop-blur-sm ${
                          currentIndex === currentRecordings.length - 1
                            ? 'bg-black/20 text-app-content-faint cursor-not-allowed'
                            : 'bg-black/50 text-app-content hover:bg-black/60'
                        }`}
              ...
              <div className="bg-app-surface border-t border-app-line/15 dark:border-[#374151] px-6 py-4 flex items-center justify-between -mt-2">
                ...
                <div className="flex items-center gap-3 mr-5">
                  <span className="text-app-content-faint text-sm font-medium">Tags:</span>
                  <button
                    onClick={() => {
                      setAllRecordings(prev => prev.map(r =>
                    ...
                    className={`px-3 py-1.5 rounded-full transition-all backdrop-blur-sm flex items-center gap-1.5 ${
                      selectedRecording.isLocked
                        ...
                        : 'bg-white/30 hover:bg-white/40 text-app-content'
                    }`}
                  >
              ...
              <div className="bg-app-card border-t border-app-line/15 dark:border-[#374151] px-6 py-4 relative hidden">
                {(() => {
                    ...
                    <div className="space-y-3 px-12">
                      ...
                      <div className="flex items-center justify-center gap-1 relative">
                        ...
                        <button
                          ...
                          className="absolute right-16 px-3 py-1.5 bg-app-sunken hover:bg-app-content/10 dark:hover:bg-[#4b5563] rounded-lg text-app-content text-xs font-medium transition-colors flex items-center gap-1.5"
                      ...
                      <div className="relative h-20 pt-2">
                          ...
                          return (
                            ...
                            >
                              <div className={`w-3 h-3 rounded-full transition-all ${
                                isSelected
                                  ? 'bg-app-navy ring-4 ring-[#5B8BBF]/30 scale-150'
                                  : hasAlarm
                                  ? 'bg-app-amber ring-2 ring-app-amber/50 hover:scale-125'
                        ...
                        {/* Background bar */}
                        <div className="absolute top-6 left-0 right-0 h-2 bg-app-sunken rounded-full" />
                        ...
                        <div
                          className="absolute top-3 h-8 w-0.5 bg-app-navy z-20 pointer-events-none"
                          ...
                          {tenMinMarkers.map((markerTime, index) => {
                            ...
                            return (
                              <div key={`10min-${index}`} className="relative" style={{ position: 'absolute', left: `${position}%`, transform: 'translateX(-50%)' }}>
                                ...
                                <div className="w-px h-1.5 bg-app-muted mx-auto" />
                                {/* Optional: Show minutes at 30-minute marks for reference */}
                                {minutes === 30 && (
                                  <div className="text-[10px] text-app-content-faint mt-0.5 whitespace-nowrap">
                          ...
                          {hourMarkers.map((markerTime, index) => {
                            ...
                            return (
                              <div key={`hour-${index}`} className="relative" style={{ position: 'absolute', left: `${position}%`, transform: 'translateX(-50%)' }}>
                                {/* Hour marker line */}
                                <div className="w-px h-2 bg-app-muted mx-auto" />
                                {/* Hour label */}
                                <div className="text-xs text-app-content-soft mt-1 whitespace-nowrap">
                                  {hour}{ampm}
                                </div>
                              </div>
                            );
                ...
                >
                  <ChevronLeft className="w-12 h-12 text-app-content-soft" />
                </button>
                ...
                >
                  <ChevronRight className="w-12 h-12 text-app-content-soft" />
                </button>
              </div>
        ...
        <>
          ...
          <div className="bg-app-surface py-3 flex items-center justify-between px-6 border-b border-app-line/8 dark:border-[#1f2937]">
            <button
              onClick={() => {
                if (showArchivedSection) {
                  setShowArchivedSection(false);
          ...
          {showUnarchivedMessage && (
            <div className="bg-[#68B08E] py-3 px-6 flex items-center justify-center border-b border-app-line/8 dark:border-[#1f2937]">
              <span className="text-app-content text-base font-medium">Video(s) have been Restored</span>
            </div>
          )}

          {showDeletedMessage && (
            <div className="bg-[#B85555] py-3 px-6 flex items-center justify-center border-b border-app-line/8 dark:border-[#1f2937]">
              <span className="text-app-content text-base font-medium">Video(s) have been Deleted</span>
            </div>
          )}

          {/* Storage Warning Notification */}
          {showStorageNotification && (
            <div className="bg-app-surface py-3 px-6 flex items-center justify-center gap-2 border-b border-app-line/8 dark:border-[#1f2937]">
          ...
          {!showArchivedSection && (
            <div className="bg-app-surface py-2 px-6 flex items-center justify-between border-b border-app-line/8 dark:border-[#1f2937]">
              <div className="flex items-center gap-3 overflow-x-auto flex-1">
                <Filter className="w-5 h-5 text-app-content-faint flex-shrink-0" />
                <button
                ...
                <div className="w-px h-6 bg-app-sunken flex-shrink-0" />
          ...
          <div className="flex-1 bg-app-surface overflow-y-auto px-5 py-3">
            {/* Archived section info banner */}
            {showArchivedSection && (
              <div className="-mx-5 -mt-3 mb-4 bg-app-surface py-3 px-6 flex items-center justify-center gap-2 border-b border-app-line/8 dark:border-[#1f2937]">
                <Info className="w-5 h-5 text-app-amber flex-shrink-0" />
                <span className="text-app-amber text-base font-medium">
            ...
            {currentRecordings.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-app-content-faint">
                  ...
                  return (
                    <div key={monthLabel} className="space-y-4">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 w-full hover:opacity-80 transition-opacity pb-1 mb-2.5 border-b border-app-line/15 dark:border-[#374151]"
                      >
                        {isMonthCollapsed ? (
                          <ChevronDown className="w-4 h-4 text-app-content-faint" />
                        ) : (
                          <ChevronUp className="w-4 h-4 text-app-content-faint" />
                        )}
                        <span className="text-app-content-faint text-xs font-semibold uppercase tracking-wider">{monthLabel}</span>
                        <span className="text-app-content-faint text-xs">({monthRecordingCount})</span>
                      </button>
                          ...
                          {Object.entries(dateGroups)
                            ...
                            return (
                              <div key={dateLabel}>
                                ...
                                >
                                  {isDateCollapsed ? (
                                    <ChevronDown className="w-5 h-5 text-app-content-faint" />
                                  ) : (
                            ...
                            return (
                              ...
                              >
                                ...
                                {!isEditingRecordings && !showArchivedSection && (
                                  <div className="absolute left-0 top-0 bottom-0 w-[240px] flex items-center justify-center bg-app-surface">
                                    <button
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        setAllRecordings(prev => prev.map(r =>
                                ...
                                <button
                                  ...
                                  className="w-full flex items-center gap-4 px-4 py-3 text-app-content hover:bg-app-sunken transition-colors cursor-pointer bg-app-card relative"
                                >
                                  ...
                                  <div className="relative w-[90px] h-16 rounded-lg overflow-hidden flex-shrink-0 border border-app-line/15 dark:border-[#374151]">
                                    {index < 3 && !downloadedRecordingIds.has(recording.id) ? (
                                      <div className="w-full h-full bg-app-sunken flex flex-col items-center justify-center gap-2 px-2">
                                        {downloadingRecordingIds.has(recording.id) ? (
                                          /* Downloading state - show "Downloading..." text and progress bar */
                                          <>
                                            <span className="text-xs text-app-content-faint font-medium">Downloading...</span>
                                            <div className="w-full bg-app-card rounded-full h-1.5 overflow-hidden">
                                              <div
                                                className="bg-[#FCEAAD] h-full rounded-full transition-all duration-300"
                                          ...
                                          <>
                                            <Camera className="w-8 h-8 text-app-content-faint" />
                                            <span className="text-xs text-app-content-faint">Sami</span>
                                          </>
                                        )}
                                      </div>
                                    ) : (
                                  ...
                                  <div className="flex-1 flex flex-col justify-center items-start min-w-0">
                                    {/* Time */}
                                    <div className="text-app-content font-semibold text-base">
                                      {(() => {
                                        const date = new Date(recording.timestamp);
                                        let hour = date.getHours();
                                        const minute = date.getMinutes();
                                    ...
                                    {/* Camera */}
                                    <div className="text-app-content-faint text-sm mt-0.5">{recording.camera}</div>
                                    {/* Duration with watch progress */}
                                    {recording.watchProgress > 0 && (
                                      <div className="w-28 h-1.5 bg-app-sunken rounded-full overflow-hidden mt-2">
                                        <div
                                          className="h-full rounded-full transition-all"
                                          style={{ width: `${recording.watchProgress}%`, backgroundColor: 'var(--app-navy)' }}
                                        />
                                      </div>
                                    )}
                                  </div>
                                  ...
                                  {/* Navigation arrow */}
                                  {!isEditingRecordings && (
                                    <ChevronRight className="w-5 h-5 text-app-content-faint flex-shrink-0 ml-2" />
                                  )}
                                </button>
                              </div>
                            );
          ...
          {isEditingRecordings && (
            <div className="bg-app-surface border-t border-app-line/15 dark:border-[#374151] py-3 px-6 flex items-center justify-between">
              {/* Selection info and buttons */}
              <div className="flex items-center gap-4">
                <span className="text-app-content text-sm font-medium">
        ...
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[480px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold text-center">Preparing Video</h2>
            </div>
            <div className="px-8 py-6 space-y-4">
              <p className="text-app-content-soft text-base text-center">Preparing video for sharing...</p>
              <div className="w-full bg-app-surface rounded-full h-3 overflow-hidden border border-app-line/15 dark:border-[#374151]">
                <div
                  className="bg-app-navy h-full rounded-full transition-none"
