  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-app-root-bg px-6 relative">
      ...
      <div className="flex flex-col items-center max-w-md text-center">
        <div className="w-32 h-32 bg-app-surface-1 rounded-3xl flex items-center justify-center mb-8 border-2 border-[#FCEAAD]">
          <Camera className="w-16 h-16 text-[#FCEAAD]" />
        </div>

        <h1 className="text-4xl mb-4 text-app-root-fg">Welcome to Sami</h1>

        <div className="bg-app-surface-1 border border-[#BFE3D9]/30 rounded-xl p-6 mb-8">
