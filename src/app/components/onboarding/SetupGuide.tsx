  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-app-root-bg px-6 py-8">
      <div className="flex flex-col items-center max-w-md w-full text-center">
        <div className="w-20 h-20 bg-app-surface-1 rounded-2xl flex items-center justify-center border-2 border-[#FCEAAD] mt-16 mb-4">
        ...
        <div className="w-full mb-8 space-y-3">
          <button
            ...
            className="w-full bg-app-surface-1 rounded-xl p-4 border border-[#FFC7BD]/30 hover:border-[#FFC7BD]/60 transition-all flex items-center gap-4 text-left"
          >
          ...
          <button
            ...
            className="w-full bg-app-surface-1 rounded-xl p-4 border border-[#FCEAAD]/30 hover:border-[#FCEAAD]/60 transition-all flex items-center gap-4 text-left"
          >
          ...
          <button
            ...
            className="w-full bg-app-surface-1 rounded-xl p-4 border border-[#BFE3D9]/30 hover:border-[#BFE3D9]/60 transition-all flex items-center gap-4 text-left"
          >
