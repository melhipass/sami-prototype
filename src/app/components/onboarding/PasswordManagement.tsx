  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-app-surface px-6">
      <div className="flex flex-col items-center max-w-md text-center">
        ...
        <h1 className="text-3xl mb-3 text-app-content">Camera Password</h1>
        <p className="text-xl text-app-content-soft mb-8">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none bg-app-card text-app-content placeholder-gray-500 ${
                showError ? 'border-[#B85555] focus:border-[#B85555]' : 'border-app-amber/30 focus:border-app-amber'
              }`}
