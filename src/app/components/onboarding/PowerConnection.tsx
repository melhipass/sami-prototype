  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-app-surface px-6 py-8">
      <div className="flex flex-col items-center max-w-md w-full text-center">
        ...
        <h1 className="text-3xl mb-3 text-app-content">Verify Camera is Ready</h1>
        ...
        {/* LED Status Flow */}
        <div className="w-full bg-app-mint rounded-xl border border-app-amber/30 px-4 py-3 mb-4">
        ...
        <div className="bg-app-mint border border-app-quiet/30 rounded-xl p-6 w-full mx-[0px] mt-[0px] mb-[20px]">
      ...
      {showTroublePopup && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center px-6">
          <div className="bg-app-mint rounded-2xl w-full max-w-md overflow-hidden border border-app-line/15 dark:border-[#374151]">
            ...
            <div className="border-t border-app-line/15 dark:border-[#374151]">
              <button
                ...
                className="w-full py-4 text-lg font-semibold transition-colors hover:bg-app-content/10 dark:hover:bg-[#374151]"
                style={{ color: 'var(--app-navy)' }}
              >
                OK
              </button>
            </div>
