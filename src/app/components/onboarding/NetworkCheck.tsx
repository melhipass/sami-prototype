    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-app-root-bg px-6 py-8">
        <div className="flex flex-col items-center max-w-md w-full text-center">
          ...
          <div className="w-full mb-8 bg-app-surface-1 rounded-xl p-6 border border-[#FFC7BD]/30 flex items-start gap-3">
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-app-root-bg px-6">
      <div className="flex flex-col items-center max-w-md text-center">
        ...
        <h2 className="text-2xl mb-4 text-app-root-fg">
          {status === 'verifying' ? 'Verifying network...' : `Searching ${networkName} for cameras...`}
        </h2>

        <p className="text-base text-app-text-2">
          {status === 'verifying'
