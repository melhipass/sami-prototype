    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-app-surface px-6 py-8">
        <div className="flex flex-col items-center max-w-md w-full text-center">
          ...
          <div className="w-full mb-8 bg-app-mint rounded-xl p-6 border border-app-alert/30 flex items-start gap-3">
          ...
          <div className="space-y-3 w-full">
            {platform === 'ios' && (
              <button
                ...
                style={{ backgroundColor: 'var(--app-navy)' }}
              >
                Go to Settings
              </button>
            )}
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-app-surface px-6">
      <div className="flex flex-col items-center max-w-md text-center">
        <div className="w-24 h-24 bg-app-mint rounded-full flex items-center justify-center mb-8 border-2 border-app-quiet">
          <Loader2 className="w-12 h-12 text-app-quiet animate-spin" />
        </div>

        <h2 className="text-2xl mb-4 text-app-content">
          {status === 'verifying' ? 'Verifying network...' : `Searching ${networkName} for cameras...`}
        </h2>

        <p className="text-base text-app-content-soft">
          {status === 'verifying'
