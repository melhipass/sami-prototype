...
const SETTINGS_ACCENT_COLOR = 'var(--app-navy)';
const SETTINGS_BG_COLOR = 'var(--app-surface)';
...
export function SettingsScreen({
  ...
  const cameraStatusColor = cameraStatus === 'Online' ? 'var(--app-quiet)'
    : cameraStatus === 'Bad Password' || cameraStatus === 'Camera needs power cycling' || cameraStatus === 'Offline' ? 'var(--app-alert)'
    : 'var(--app-amber)'; // Updating..., Connecting, Waiting for camera to start
  ...
  const cameraSignalColor = cameraSignal === 'Excellent' ? 'var(--app-quiet)'
    : cameraSignal === 'Ok' ? 'var(--app-amber)'
    : cameraSignal === 'Wired' ? 'var(--app-quiet)'
    : 'var(--app-alert)'; // Bad, Poor, NONE
  ...
  const overallScheduleSummary = (): { text: string; color: string } => {
    if (schedules.every(s => !s.enabled)) return { text: 'Disabled', color: 'var(--app-alert)' };
    if (schedules.some(s => s.enabled && s.allDay && s.days.every(Boolean))) return { text: 'All day, Everyday', color: 'var(--app-quiet)' };
    return { text: 'Custom', color: 'var(--app-amber)' };
  };
  ...
  return (
    <div className="absolute inset-0 bg-app-surface z-30 flex flex-col">
      ...
      <div className="bg-app-surface py-4 flex items-center justify-between">
        ...
        <span
          className="text-app-content text-lg font-medium cursor-pointer select-none"
      ...
      {/* Settings content */}
      <div className="flex-1 bg-app-surface overflow-y-auto px-6">
        <div className="space-y-8 py-6">

          {/* Devices Section */}
          <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Devices</h3>
              ...
              <div className="space-y-1">
                ...
                {cameraPaired ? (
                  <div
                    ...
                    className="w-full px-4 py-4 text-app-content flex items-center gap-3 cursor-pointer"
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-app-content-faint mt-0.5">offline</div>
                    </div>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                  ...
                  >
                    ...
                    <ChevronRight className="w-10 h-10 text-app-content flex-shrink-0" />
                  </div>
                )}
              </div>
            </div>
          ...
          {selectedOS === 'android' && <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Network</h3>
            <div className="bg-app-card rounded-lg overflow-hidden px-4">
              <button
                onClick={() => {
              ...
              >
                <div className="flex items-center gap-3">
                  <Wifi className="w-5 h-5 text-app-content-faint" />
                  <div className="text-left">
                    <span className="text-app-content block">Wi-Fi Network</span>
                    <span className="text-app-content-faint text-sm">{settingsWifiNetwork}</span>
                  </div>
                </div>
                <ChevronRight className="w-10 h-10 text-app-content" />
              </button>
            </div>
          </div>}
          ...
          {/* Alarms Section */}
          <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Alarms</h3>
            <div className="bg-app-card rounded-lg overflow-hidden px-4">
              <div className="space-y-0">
              {/* Enable Alarm */}
              <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content">Enable Alarm</span>
                <button
                  onClick={handleEnableAlarmToggle}
                  className={`w-14 h-8 rounded-full transition-colors relative ${
                    enableAlarm ? '' : 'bg-app-muted'
                  }`}
              ...
              {/* Motion Threshold */}
              <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content text-lg w-48">Motion Threshold</span>
                <div className="flex items-center gap-3 flex-1 justify-end">
                  <button
                    onClick={() => setMotionThresholdSetting(Math.max(0, motionThresholdSetting - 1))}
                    className="w-8 h-8 bg-app-sunken hover:bg-app-content/10 dark:hover:bg-[#4b5563] rounded flex items-center justify-center text-app-content"
                  >
                    −
                  </button>
                  <div className="relative w-64">
                    <div className="h-1 bg-app-sunken rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${motionThresholdSetting}%`, backgroundColor: 'var(--app-navy)' }}
                      />
                    </div>
                    <input
                      type="range"
                    ...
                    <div
                      ...
                      style={{ left: `calc(${motionThresholdSetting}% - 10px)`, borderColor: 'var(--app-navy)' }}
                    />
                  </div>
                  <button
                  ...
                  <span className="text-app-content w-[80px] text-right">{motionThresholdSetting}%</span>
                </div>
              </div>

              {/* Alarm Threshold */}
              <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content text-lg w-48">Alarm Threshold</span>
                <div className="flex items-center gap-3 flex-1 justify-end">
                  <button
                  ...
                  <div className="relative w-64">
                    <div className="h-1 bg-app-sunken rounded-full overflow-hidden">
                      <div
                        className="h-full transition-all duration-200"
                        style={{ width: `${(alarmThresholdSetting / 900) * 100}%`, backgroundColor: 'var(--app-navy)' }}
                      />
                    </div>
                    <input
                      type="range"
                    ...
                    <div
                      className="absolute top-1/2 -translate-y-1/2 w-5 h-5 bg-white rounded-full border-2 pointer-events-none shadow-lg"
                      style={{ left: `calc(${(alarmThresholdSetting / 900) * 100}% - 10px)`, borderColor: 'var(--app-navy)' }}
                    />
                  </div>
                  <button
                  ...
                  <span className="text-app-content w-[80px] text-right">
              ...
              {/* Sensitivity Boost */}
              <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content text-lg w-48">Sensitivity Boost</span>
                <div className="flex items-center gap-3 flex-1 justify-end">
                  <button
                  ...
                  <div className="relative w-64">
                    <div className="h-1 bg-app-sunken rounded-full overflow-hidden">
                      <div
                        className="h-full transition-all duration-200"
                        style={{ width: `${sensitivityBoost}%`, backgroundColor: 'var(--app-navy)' }}
                      />
                    </div>
                    <input
                      type="range"
                    ...
                    <div
                      className="absolute top-1/2 -translate-y-1/2 w-5 h-5 bg-white rounded-full border-2 pointer-events-none shadow-lg"
                      style={{ left: `calc(${sensitivityBoost}% - 10px)`, borderColor: 'var(--app-navy)' }}
                    />
                  </div>
                  <button
                  ...
                  <span className="text-app-content w-[80px] text-right">{sensitivityBoost}%</span>
                </div>
              </div>

              {/* Max Pause Time */}
              <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content text-lg w-48">Max Pause Time</span>
                <div className="flex items-center gap-3 flex-1 justify-end">
                  <button
              ...
              {/* Smart Border */}
              <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content">Smart Border <span className="text-sm italic">(Smart Edge)</span></span>
                <button
                  onClick={handleSmartBorderToggle}
                  className={`w-14 h-8 rounded-full transition-colors relative ${
                    smartBorder ? '' : 'bg-app-muted'
                  }`}
              ...
              <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content">Beep on Camera Fault</span>
                <button
                  onClick={() => handleBeepOnCameraFaultToggle(!beepOnCameraFault)}
                  className={`w-14 h-8 rounded-full transition-colors relative ${
                    beepOnCameraFault ? '' : 'bg-app-muted'
                  }`}
              ...
              <div className="flex items-center justify-between py-4">
                <span className="text-app-content">Beep on App Not Active</span>
                <button
                  onClick={() => handleBeepOnAppNotActiveToggle(!beepOnAppNotActive)}
                  className={`w-14 h-8 rounded-full transition-colors relative ${
                    beepOnAppNotActive ? '' : 'bg-app-muted'
                  }`}
          ...
          {/* Schedule Section */}
          <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Schedule</h3>
            <div className="bg-app-card rounded-lg overflow-hidden px-4">
              <div className="space-y-0">
                {/* Enable Alarm Schedule */}
                <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content">Enable Alarm Schedule</span>
                  <button
                    onClick={() => setEnableAlarmSchedule(!enableAlarmSchedule)}
                    className={`w-14 h-8 rounded-full transition-colors relative ${
                      enableAlarmSchedule ? '' : 'bg-app-muted'
                    }`}
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between py-4 bg-transparent text-app-content transition-colors border-b border-app-line/15 dark:border-[#374151]"
                >
                  <span className="text-app-content">Alarm Enable Time</span>
                  <div className="flex items-center gap-3">
                    <span className="text-app-content-faint">{formatTime(alarmEnableHour, alarmEnableMinute, alarmEnablePeriod)}</span>
                    <ChevronRight className="w-10 h-10 text-app-content" />
                  </div>
                </button>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between py-4 bg-transparent text-app-content transition-colors"
                >
                  <span className="text-app-content">Alarm Disable Time</span>
                  <div className="flex items-center gap-3">
                    <span className="text-app-content-faint">{formatTime(alarmDisableHour, alarmDisableMinute, alarmDisablePeriod)}</span>
                    <ChevronRight className="w-10 h-10 text-app-content" />
                  </div>
                </button>
              </div>
          ...
          {/* Audio Section */}
          <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Audio</h3>
            <div className="bg-app-card rounded-lg overflow-hidden px-4">
              <div className="space-y-0">
              {/* Alarm Volume */}
              <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content text-lg w-48">Alarm Volume</span>
                <div className="flex items-center gap-3 flex-1 justify-end">
                  <button
                  ...
                  <span className="text-app-content w-[80px] text-right">{alarmVolume}%</span>
                </div>
              </div>

              {/* Alarm Sound */}
              <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content">Alarm Sound</span>
                <div className="flex">
              ...
              {/* Alarm Duration */}
              <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content text-lg w-48">Alarm Duration</span>
                <div className="flex items-center gap-3 flex-1 justify-end">
                  <button
                  ...
                  <span className="text-app-content w-[80px] text-right">{formatAlarmDuration(alarmDuration)}</span>
                </div>
              </div>

              {/* Vibrate on Alarm */}
              <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content">Vibrate on Alarm</span>
                <button
                  onClick={() => setVibrateOnAlarm(!vibrateOnAlarm)}
                  className={`w-14 h-8 rounded-full transition-colors relative ${
                    vibrateOnAlarm ? '' : 'bg-app-muted'
                  }`}
              ...
              {/* Microphone Boost */}
              <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                <span className="text-app-content">Microphone Boost</span>
                <button
                  onClick={() => {
                    if (!microphoneBoost) {
              ...
              <div className="flex items-center justify-between py-4">
                <span className="text-app-content">Microphone Noise Reduction</span>
                <button
                  onClick={() => {
                  ...
                  className={`w-14 h-8 rounded-full transition-colors relative ${
                    microphoneNoiseReduction ? '' : 'bg-app-muted'
                  }`}
          ...
          {/* Display Section */}
          <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Display</h3>
            <div className="bg-app-card rounded-lg overflow-hidden px-4">
              <div className="space-y-0">
                {/* Screen Timeout to Clock */}
                <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content">Screen Timeout to Clock</span>
                  <button
                    onClick={() => setScreenTimeoutToClock(!screenTimeoutToClock)}
                    className={`w-14 h-8 rounded-full transition-colors relative ${
                      screenTimeoutToClock ? '' : 'bg-app-muted'
                    }`}
                ...
                {/* Timeout Delay */}
                <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content text-lg w-48">Timeout Delay</span>
                  <div className="flex items-center gap-3 flex-1 justify-end">
                    <button
                    ...
                    <span className="text-app-content w-[80px] text-right">{formatTimeoutDelay(timeoutDelay)}</span>
                  </div>
                </div>
          ...
          {/* Recordings Section */}
          <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Recordings</h3>
            <div className="bg-app-card rounded-lg overflow-hidden px-4">
              <div className="space-y-0">
                {/* Enable Automatic Recording Transfers */}
                <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content">Enable Automatic Recording Transfers</span>
                  <button
                    onClick={() => setEnableAutoRecording(!enableAutoRecording)}
                    className={`w-14 h-8 rounded-full transition-colors relative ${
                      enableAutoRecording ? '' : 'bg-app-muted'
                    }`}
                ...
                {/* Storage Limit */}
                <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content text-lg w-48">Storage Limit</span>
                  <div className="flex items-center gap-3 flex-1 justify-end">
                    <button
                    ...
                    <span className="text-app-content w-[80px] text-right">{storageLimit}GB</span>
                  </div>
                </div>

                {/* Auto-Delete Older Videos */}
                <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content">Automatically-Delete Older Videos</span>
                  <button
                    onClick={() => {
                    ...
                    className={`w-14 h-8 rounded-full transition-colors relative ${
                      autoDeleteOlderVideos ? '' : 'bg-app-muted'
                    }`}
          ...
          {/* Mobile Data Section */}
          <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Mobile Data</h3>
            <div className="bg-app-card rounded-lg overflow-hidden px-4">
              <div className="space-y-0">
                {/* Always Allow Mobile Data */}
                <div className="flex items-center justify-between py-4">
                  <span className="text-app-content">Always Allow Mobile Data</span>
                  <button
                    onClick={() => setAlwaysAllowMobileData(!alwaysAllowMobileData)}
                    className={`w-14 h-8 rounded-full transition-colors relative ${
                      alwaysAllowMobileData ? '' : 'bg-app-muted'
                    }`}
          ...
          <div>
            <h3 className="text-app-content text-xl font-bold mb-3 px-4">Data Analytics</h3>
            <div className="bg-app-card rounded-lg overflow-hidden px-4">
              <div className="space-y-0">
                {/* Unable Sent Data */}
                <div className="flex items-center justify-between py-4">
                  <span className="text-app-content">Use my anonymous data</span>
                  <button
                    onClick={() => setEnableSentData(!enableSentData)}
                    className={`w-14 h-8 rounded-full transition-colors relative ${
                      enableSentData ? '' : 'bg-app-muted'
                    }`}
          ...
          {showQCSection && (
            <div>
              <h3 className="text-app-content text-xl font-bold mb-3 px-4">QC</h3>
              <div className="bg-app-card rounded-lg overflow-hidden px-4">
                <div className="space-y-0">
                  {/* Display Data */}
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content">Display Data</span>
                    <button
                      onClick={() => setDisplayData(!displayData)}
                      className={`w-14 h-8 rounded-full transition-colors relative ${
                        displayData ? '' : 'bg-app-muted'
                      }`}
                  ...
                  {/* Rapid Test Mode */}
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content">Rapid Test Mode</span>
                    <button
                      onClick={() => setRapidTestMode(!rapidTestMode)}
                      className={`w-14 h-8 rounded-full transition-colors relative ${
                        rapidTestMode ? '' : 'bg-app-muted'
                      }`}
                  ...
                  {/* Burning Mode */}
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content">Burning Mode</span>
                    <button
                      onClick={() => setBurningMode(!burningMode)}
                      className={`w-14 h-8 rounded-full transition-colors relative ${
                        burningMode ? '' : 'bg-app-muted'
                      }`}
                  ...
                  {/* Min Wi-Fi Quality */}
                  <div className="flex items-center py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content text-lg w-48">Min Wi-Fi Quality</span>
                    <div className="flex items-center gap-3 flex-1 justify-end">
                      <button
                      ...
                      <span className="text-app-content w-[80px] text-right">{minWifiQuality}</span>
                    </div>
                  </div>

                  {/* Dev AWS */}
                  <div className="flex items-center justify-between py-4">
                    <span className="text-app-content">Dev AWS</span>
                    <button
      ...
      {showPairingPopup && (
        <div className="absolute inset-0 bg-black/70 z-40 flex items-center justify-center">
          <div className="bg-app-card rounded-lg px-12 py-8 text-center">
            <div className="text-app-content text-2xl font-medium">Pairing Camera</div>
            <div className="mt-4">
      ...
      {showResetDialog && (
        <div className="absolute inset-0 bg-black/70 z-40 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[700px] overflow-hidden">
            {/* Options */}
            <div className="px-8 py-6 space-y-6">
              {/* Option 1 */}
              <div className="flex items-center justify-between gap-6 pb-6 border-b border-app-line/15 dark:border-[#374151]">
                <div className="flex-1">
                  <p className="text-app-content text-base leading-relaxed">
                    Resets values for alarm, schedule, audio, display and recordings.
                  </p>
                </div>
                <button
                  onClick={handleResetUserSettings}
                  className="px-4 py-2 bg-app-sunken hover:bg-app-content/10 dark:hover:bg-[#4b5563] text-app-content rounded-lg transition-colors whitespace-nowrap font-semibold text-sm"
                >
                  Reset User Settings
                </button>
              </div>
              ...
              <div className="flex items-center justify-between gap-6">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-red-600 hover:bg-red-500 text-app-content rounded-lg transition-colors whitespace-nowrap font-semibold text-sm"
                >
                  Erase All Content
                </button>
              </div>
            ...
            <div className="border-t border-app-line/15 dark:border-[#374151]">
              <button
                ...
                className="w-full text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold"
        ...
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[600px] overflow-hidden">
            ...
            <div className="px-8 pt-6">
              <h2 className="text-app-content text-2xl font-semibold text-center">Are you sure?</h2>
            </div>
            ...
            <div className="border-t border-app-line/15 dark:border-[#374151] grid grid-cols-2">
              <button
                ...
                className="text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold border-r border-app-line/15 dark:border-[#374151] text-red-500"
              >
                Erase All
              </button>
              <button
                onClick={() => setShowEraseConfirmDialog(false)}
                className="text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold text-app-content-faint"
              >
                Cancel
              </button>
            </div>
      ...
      {showResetAllConfirmDialog && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[650px] overflow-hidden">
            {/* Title */}
            <div className="px-8 pt-6">
              <h2 className="text-app-content text-2xl font-semibold text-center">Are you sure?</h2>
            </div>
      ...
      {showCameraFaultPopup && (
        <div className="absolute inset-0 bg-black/70 z-40 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[500px] overflow-hidden">
            {/* Title */}
            <div className="text-app-content text-xl font-semibold text-center py-4 border-b border-app-line/15 dark:border-[#374151]">
              Can't find Sami camera
            </div>

            {/* Description */}
            <div className="px-6 py-6">
              <p className="text-app-content text-center text-lg">
      ...
      {showCameraSettings && (
        <div
          className="absolute inset-0 bg-app-surface z-40 flex flex-col animate-slide-in-right"
          style={{
        ...
        >
          ...
          <div className="bg-app-surface py-4 flex items-center justify-between">
            ...
            <span className="text-app-content text-lg font-medium">Camera Settings</span>
          ...
          <div className="flex-1 overflow-y-auto px-6" style={{ backgroundColor: SETTINGS_BG_COLOR }}>
            <div className="py-6 space-y-8">
              ...
              <div>
                <div className="bg-app-card rounded-lg overflow-hidden px-4">
                  {/* Camera Status */}
                  <div className={`flex items-center justify-between py-4 ${showCameraPasswordRow ? 'border-b border-app-line/15 dark:border-[#374151]' : ''}`}>
                    <span className="text-app-content text-base">Camera Status</span>
                  ...
                  {showCameraPasswordRow && (
                    <div className={`flex items-center justify-between py-4 ${showFullCameraSettings ? 'border-b border-app-line/15 dark:border-[#374151]' : ''}`}>
                      <span className="text-app-content text-base">Camera Password</span>
                      <div className="flex items-center gap-4">
                  ...
                  {showFullCameraSettings && (
                    <div className="flex items-center justify-between py-4">
                      <span className="text-app-content text-base">Camera Wi-Fi [{cameraWifiNetwork}]</span>
                      <div className="flex items-center gap-4">
              ...
              {/* ── Image ── */}
              <div>
                <h3 className="text-app-content text-xl font-bold mb-3 px-4">Image</h3>
                <div className="bg-app-card rounded-lg overflow-hidden px-4">
                  {/* Night Vision Mode */}
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content text-base">Night Vision Mode</span>
                    <div className="flex">
                  ...
                  {/* IR Illuminator Mode */}
                  <div className="flex items-center justify-between py-4">
                    <span className="text-app-content text-base">IR Illuminator Mode</span>
                    <div className="flex">
              ...
              <div>
                ...
                <div className="bg-app-card rounded-lg overflow-hidden px-4">
                  {/* Record Mode */}
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content text-base">Record Mode</span>
                    <div className="flex">
                  ...
                  {(() => {
                    ...
                    return (
                      <div className={`flex flex-col py-4 border-b border-app-line/15 dark:border-[#374151] transition-opacity ${rtDisabled ? 'opacity-40' : ''}`}>
                        <div className="flex items-center">
                          <span className="text-app-content text-lg w-48">Record Threshold</span>
                          <div className="flex items-center gap-3 flex-1 justify-end">
                  ...
                  {/* SD Card */}
                  <div className="flex items-center justify-between py-4">
                    <span className="text-app-content text-base">SD Card</span>
                    <div className="flex items-center gap-4">
              ...
              {/* ── Network Connection ── */}
              <div>
                <h3 className="text-app-content text-xl font-bold mb-3 px-4">Network Connection</h3>
                <div className="bg-app-card rounded-lg overflow-hidden px-4">
                  {/* Internet Viewing */}
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content text-base">Internet Viewing</span>
                    <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content text-base">Power Light Flash on Internet Viewer</span>
                    <button
                      onClick={() => setPowerLightFlash(!powerLightFlash)}
                      className={`w-14 h-8 rounded-full transition-colors relative ${powerLightFlash ? '' : 'bg-app-muted'}`}
                  ...
                  <div className="flex flex-col py-4">
                    ...
                    {ipSaveError && <p className="text-sm mt-2" style={{ color: 'var(--app-alert)' }}>Couldn't save network settings, camera didn't respond.</p>}
                  </div>
                </div>
              </div>
              ...
              {/* ── General ── */}
              <div>
                <h3 className="text-app-content text-xl font-bold mb-3 px-4">General</h3>
                <div className="bg-app-card rounded-lg overflow-hidden px-4">
                  {/* Restart Camera */}
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
      ...
      {showSmartBorderPopup1 && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[600px] overflow-hidden">
            {/* Title */}
            <div className="px-8 pt-6">
              <h2 className="text-app-content text-2xl font-semibold text-center">Enable Smart Border</h2>
            </div>
      ...
      {showSmartBorderPopup2 && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[600px] overflow-hidden">
            {/* Title */}
            <div className="px-8 pt-6">
              <h2 className="text-app-content text-2xl font-semibold text-center">Changes on Border Functionality</h2>
            </div>
          ...
          <div className="bg-app-card rounded-lg w-[500px] overflow-hidden">
            ...
            <div className="flex items-center justify-center gap-4 py-8 px-8">
              ...
              <div className="flex flex-col items-center">
                ...
                {[-2, -1].map(offset => {
                  ...
                  return (
                    <button
                      ...
                      className="text-app-content-faint text-xl py-1 w-20 text-center hover:text-app-content-faint transition-colors"
                    >
                      {displayHour}
                    </button>
                  );
                ...
                {/* Selected hour */}
                <div className="text-app-content text-4xl font-semibold py-2 w-20 text-center">
              ...
              <div className="text-app-content text-4xl font-semibold">:</div>
              ...
              <div className="flex flex-col items-center ml-4">
                ...
                <button
                  ...
                  className="text-app-content text-4xl font-semibold py-2 w-20 text-center"
                >
                  {alarmEnablePeriod}
                </button>
      ...
      {showRemoveCameraConfirm && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 py-6">
              <p className="text-app-content-soft text-base leading-relaxed text-center">
                Are you sure you want to remove this camera? If you want to reconnect again without needing to reset the camera, save this password: <span className="text-app-content font-semibold">{savedCameraPassword || 'N/A'}</span>.
              </p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              ...
              <button
                ...
                className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold text-[#B95555]"
              >
                Remove
              </button>
            </div>
      ...
      {showBadPasswordPopup && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[600px] overflow-hidden">
            {/* Title */}
            <div className="px-8 pt-6">
              <h2 className="text-app-content text-2xl font-semibold text-center">Bad Password</h2>
            </div>
            ...
            {/* Buttons */}
            <div className="border-t border-app-line/15 dark:border-[#374151] flex flex-col">
              <button
                onClick={() => {
              ...
              <button
                ...
                className="text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold w-full text-app-content-faint"
              >
                Cancel
              </button>
            </div>
        ...
        return (
          <div className="absolute inset-0 bg-app-surface z-50 flex flex-col">
            <div className="bg-app-surface py-4 flex items-center justify-between">
              ...
              <span className="text-app-content text-lg font-medium">Record Schedule</span>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
              <div className="bg-app-card rounded-lg overflow-hidden px-4">
                {/* Enabled toggle */}
                <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content">Enabled</span>
                  <button
                    onClick={() => {
                    ...
                    className={`w-14 h-8 rounded-full transition-colors relative ${editingSchedule.enabled ? '' : 'bg-app-muted'}`}
                ...
                {/* All Day toggle */}
                <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content">All Day</span>
                  <button
                    onClick={() => {
                    ...
                    className={`w-14 h-8 rounded-full transition-colors relative ${editingSchedule.allDay ? '' : 'bg-app-muted'}`}
                ...
                {!editingSchedule.allDay && (
                  <button
                    ...
                    className="w-full flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]"
                  >
                    <span className="text-app-content">Start Time</span>
                    <div className="flex items-center gap-3">
                      <span className="text-app-content-faint">{fmt(editingSchedule.startHour, editingSchedule.startMinute, editingSchedule.startPeriod)}</span>
                      <ChevronRight className="w-10 h-10 text-app-content" />
                    </div>
                  </button>
                )}
                ...
                {!editingSchedule.allDay && (
                  <button
                    ...
                    className="w-full flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]"
                  >
                    <span className="text-app-content">End Time</span>
                    <div className="flex items-center gap-3">
                      <span className="text-app-content-faint">{fmt(editingSchedule.endHour, editingSchedule.endMinute, editingSchedule.endPeriod)}</span>
                      <ChevronRight className="w-10 h-10 text-app-content" />
                    </div>
                  </button>
                )}
                ...
                {/* Day selector */}
                <div className="py-4">
                  <span className="text-app-content text-base block mb-3">Days</span>
            ...
            {showScheduleStartPicker && (
              <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
                <div className="bg-app-card rounded-lg w-[500px] overflow-hidden">
                  <div className="text-app-content text-xl font-semibold text-center py-4 border-b border-app-line/15 dark:border-[#374151]">Start Time</div>
                  <div className="flex items-center justify-center gap-4 py-8 px-8">
                    {/* Hour */}
                    <div className="flex flex-col items-center">
                      {[-2,-1].map(o => { const h = editingSchedule.startHour + o; const d = h <= 0 ? h + 12 : h; return <button key={o} onClick={() => setEditingSchedule({...editingSchedule, startHour: d})} className="text-app-content-faint text-xl py-1 w-20 text-center">{d}</button>; })}
                      <div className="text-app-content text-4xl font-semibold py-2 w-20 text-center">{editingSchedule.startHour === 0 ? 12 : editingSchedule.startHour}</div>
                      {[1,2].map(o => { const h = editingSchedule.startHour + o; const d = h > 12 ? h - 12 : h; return <button key={o} onClick={() => setEditingSchedule({...editingSchedule, startHour: d})} className="text-app-content-faint text-xl py-1 w-20 text-center">{d}</button>; })}
                    </div>
                    <div className="text-app-content text-4xl font-semibold">:</div>
                    {/* Minute */}
                    <div className="flex flex-col items-center">
                      {[-2,-1].map(o => { const m = (editingSchedule.startMinute + o + 60) % 60; return <button key={o} onClick={() => setEditingSchedule({...editingSchedule, startMinute: m})} className="text-app-content-faint text-xl py-1 w-20 text-center">{m.toString().padStart(2,'0')}</button>; })}
                      <div className="text-app-content text-4xl font-semibold py-2 w-20 text-center">{editingSchedule.startMinute.toString().padStart(2,'0')}</div>
                      {[1,2].map(o => { const m = (editingSchedule.startMinute + o) % 60; return <button key={o} onClick={() => setEditingSchedule({...editingSchedule, startMinute: m})} className="text-app-content-faint text-xl py-1 w-20 text-center">{m.toString().padStart(2,'0')}</button>; })}
                    </div>
                    {/* AM/PM */}
                  ...
                  <div className="border-t border-app-line/15 dark:border-[#374151]">
                    <button onClick={() => setShowScheduleStartPicker(false)} className="w-full text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold" style={{ color: SETTINGS_ACCENT_COLOR }}>Done</button>
                  </div>
                </div>
              </div>
            )}
            ...
            {showScheduleEndPicker && (
              <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
                <div className="bg-app-card rounded-lg w-[500px] overflow-hidden">
                  <div className="text-app-content text-xl font-semibold text-center py-4 border-b border-app-line/15 dark:border-[#374151]">End Time</div>
                  <div className="flex items-center justify-center gap-4 py-8 px-8">
                    {/* Hour */}
                    <div className="flex flex-col items-center">
                      {[-2,-1].map(o => { const h = editingSchedule.endHour + o; const d = h <= 0 ? h + 12 : h; return <button key={o} onClick={() => setEditingSchedule({...editingSchedule, endHour: d})} className="text-app-content-faint text-xl py-1 w-20 text-center">{d}</button>; })}
                      <div className="text-app-content text-4xl font-semibold py-2 w-20 text-center">{editingSchedule.endHour === 0 ? 12 : editingSchedule.endHour}</div>
                    ...
                    {/* Minute */}
                    <div className="flex flex-col items-center">
                      {[-2,-1].map(o => { const m = (editingSchedule.endMinute + o + 60) % 60; return <button key={o} onClick={() => setEditingSchedule({...editingSchedule, endMinute: m})} className="text-app-content-faint text-xl py-1 w-20 text-center">{m.toString().padStart(2,'0')}</button>; })}
                      <div className="text-app-content text-4xl font-semibold py-2 w-20 text-center">{editingSchedule.endMinute.toString().padStart(2,'0')}</div>
                      {[1,2].map(o => { const m = (editingSchedule.endMinute + o) % 60; return <button key={o} onClick={() => setEditingSchedule({...editingSchedule, endMinute: m})} className="text-app-content-faint text-xl py-1 w-20 text-center">{m.toString().padStart(2,'0')}</button>; })}
                    </div>
                    {/* AM/PM */}
                    <div className="flex flex-col items-center gap-3 ml-4">
                      {(['AM','PM'] as const).map(p => (
                  ...
                  <div className="border-t border-app-line/15 dark:border-[#374151]">
                    <button onClick={() => setShowScheduleEndPicker(false)} className="w-full text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold" style={{ color: SETTINGS_ACCENT_COLOR }}>Done</button>
                  </div>
                </div>
              </div>
            )}
      ...
      {/* Internet Viewing Screen */}
      {showIVScreen && (
        <div className="absolute inset-0 bg-app-surface z-50 flex flex-col" style={{ animation: 'slideInRight 0.3s ease-out forwards' }}>
          ...
          <div className="bg-app-surface py-4 flex items-center justify-between flex-shrink-0">
            ...
            <span className="text-app-content text-lg font-medium">Internet Viewing</span>
          ...
          <div className="flex-1 overflow-y-auto px-6" style={{ backgroundColor: SETTINGS_BG_COLOR }}>
            {/* Instructional text */}
            <p className="text-app-content-faint text-sm leading-relaxed py-4 border-b border-app-line/15 dark:border-[#374151]">
            ...
            <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
              <span className="text-app-content text-base">Enable Internet Access</span>
              <button
                onClick={handleIVToggle}
                disabled={ivToggleBusy}
                className={`w-14 h-8 rounded-full transition-colors relative ${ivToggleBusy ? 'opacity-50 cursor-not-allowed' : ''} ${!internetViewingEnabled ? 'bg-app-muted' : ''}`}
            ...
            {internetViewingEnabled && (
              <>
                {/* Status row */}
                <div
                  className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151] cursor-pointer"
                  onClick={() => {
                ...
                >
                  <span className="text-app-content text-base">Status - touch to check again</span>
                  <div className="flex items-center gap-2">
                    <span className="text-base font-medium" style={{
                      color: ivStatus === 'Online' ? 'var(--app-quiet)'
                        : ivStatus === 'Checking...' ? 'var(--app-amber)'
                        : ivStatus === '---' ? '#888'
                        : 'var(--app-alert)'
                    }}>{ivStatus}</span>
                    <RefreshCw className="w-4 h-4 text-app-content-faint" />
                  </div>
                </div>

                {/* Configure Router */}
                <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <span className="text-app-content text-base">Configure Router</span>
                  <div className="flex rounded-lg overflow-hidden border border-app-line/20 dark:border-[#4b5563]">
                ...
                {ivRouterMode === 'manual' && (
                  <div className="py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-app-content text-base">Port Number</span>
                    </div>
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-3 rounded-lg bg-app-surface text-app-content border border-app-line/20 dark:border-[#4b5563] focus:border-[#5A8BBF] focus:outline-none text-base"
                      />
                      {ivPortEditing && (
                        <>
                          <button
                            onClick={() => { setIvPortNumber(ivSavedPortNumber); setIvPortEditing(false); }}
                            className="px-4 py-2 rounded-lg text-sm text-app-content-soft bg-app-sunken hover:bg-app-content/10 dark:hover:bg-[#4b5563] transition-colors"
                          >Cancel</button>
                          <button
                            onClick={() => {
            ...
            <div className="absolute inset-0 bg-black/70 z-10 flex items-center justify-center">
              <div className="bg-app-card rounded-lg w-[480px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
                <div className="px-8 pt-6 pb-2">
                  <h2 className="text-app-content text-xl font-semibold text-center">
          ...
          {ivPopup === 'no-internet' && (
            <div className="absolute inset-0 bg-black/70 z-20 flex items-center justify-center">
              <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
                <div className="px-8 pt-6 pb-2"><h2 className="text-app-content text-xl font-semibold text-center">No Internet Connection</h2></div>
                <div className="px-8 py-5"><p className="text-app-content-soft text-base leading-relaxed text-center">Your camera must be connected to a network with access to the internet to enable this.</p></div>
                <div className="border-t border-app-line/15 dark:border-[#374151]"><button onClick={() => setIvPopup(null)} className="w-full text-lg py-4 hover:bg-app-sunken transition-colors font-semibold" style={{ color: SETTINGS_ACCENT_COLOR }}>Ok</button></div>
              </div>
            </div>
          )}
          {ivPopup === 'upnp-failed' && (
            <div className="absolute inset-0 bg-black/70 z-20 flex items-center justify-center">
              <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
                <div className="px-8 pt-6 pb-2"><h2 className="text-app-content text-xl font-semibold text-center">UPnP Failed</h2></div>
                <div className="px-8 py-5"><p className="text-app-content-soft text-base leading-relaxed text-center">Your router did not accept the UPnP port setting. Enable UPnP on your router and try again or manually configure the port.</p></div>
                <div className="border-t border-app-line/15 dark:border-[#374151]"><button onClick={() => setIvPopup(null)} className="w-full text-lg py-4 hover:bg-app-sunken transition-colors font-semibold" style={{ color: SETTINGS_ACCENT_COLOR }}>Ok</button></div>
              </div>
            </div>
          )}
          {ivPopup === 'manual-port-error' && (
            <div className="absolute inset-0 bg-black/70 z-20 flex items-center justify-center">
              <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
                <div className="px-8 pt-6 pb-2"><h2 className="text-app-content text-xl font-semibold text-center">Port Configuration Failed</h2></div>
                <div className="px-8 py-5"><p className="text-app-content-soft text-base leading-relaxed text-center">Couldn&apos;t configure the manual port. Please try again.</p></div>
                <div className="border-t border-app-line/15 dark:border-[#374151]"><button onClick={() => setIvPopup(null)} className="w-full text-lg py-4 hover:bg-app-sunken transition-colors font-semibold" style={{ color: SETTINGS_ACCENT_COLOR }}>Ok</button></div>
              </div>
            </div>
          )}
          {ivPopup === 'warn-disable' && (
            <div className="absolute inset-0 bg-black/70 z-20 flex items-center justify-center">
              <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
                <div className="px-8 pt-6 pb-2"><h2 className="text-app-content text-xl font-semibold text-center">Warning</h2></div>
                <div className="px-8 py-5"><p className="text-app-content-soft text-base leading-relaxed text-center">You are connected via the Internet now. If you disable this you will be disconnected and will not be able to reconnect until you connect via local Wi-Fi.</p></div>
                <div className="border-t border-app-line/15 dark:border-[#374151] flex">
                  <button onClick={() => setIvPopup(null)} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold border-r border-app-line/15 dark:border-[#374151]" style={{ color: SETTINGS_ACCENT_COLOR }}>Cancel</button>
                  <button onClick={ivConfirmDisable} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold" style={{ color: 'var(--app-alert)' }}>Disable</button>
                </div>
              </div>
            </div>
          )}
      ...
      {showIpEditor && (
        <div className="absolute inset-0 bg-app-surface z-50 flex flex-col" style={{ animation: 'slideInRight 0.3s ease-out forwards' }}>
          ...
          <div className="flex-1 overflow-y-auto px-6" style={{ backgroundColor: SETTINGS_BG_COLOR }}>
            {/* Mode toggle */}
            <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
              <span className="text-app-content text-base">Mode</span>
              <div className="flex rounded-lg overflow-hidden border border-app-line/20 dark:border-[#4b5563]">
            ...
            {ipEditorMode === 'manual' && (() => {
              const ipField = (label: string, key: 'ip' | 'subnet' | 'gateway' | 'dns1' | 'dns2', placeholder: string) => (
                <div key={key} className="py-4 border-b border-app-line/15 dark:border-[#374151]">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-app-content text-base">{label}</span>
                  </div>
                  <input
                    type="text"
                    inputMode="decimal"
                    ...
                    className={`w-full px-4 py-3 rounded-lg bg-app-surface text-app-content border focus:outline-none text-base ${ipErrors[key] ? 'border-app-alert' : 'border-app-line/20 dark:border-[#4b5563] focus:border-[#5A8BBF]'}`}
                  />
                  {ipErrors[key] && <p className="text-sm mt-1" style={{ color: 'var(--app-alert)' }}>{ipErrors[key]}</p>}
                </div>
              );
              return (
                <>
                  ...
                  {/* Configure DNS */}
                  <div className="flex items-center justify-between py-4 border-b border-app-line/15 dark:border-[#374151]">
                    <span className="text-app-content text-base">Configure DNS</span>
                    <div className="flex rounded-lg overflow-hidden border border-app-line/20 dark:border-[#4b5563]">
      ...
      {showIpWarning && (
        <div className="absolute inset-0 bg-black/70 z-[60] flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold text-center">Warning</h2>
            </div>
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">Make sure your settings are correct. If not the camera may not reconnect and need to be reset.</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              <button onClick={() => setShowIpWarning(false)} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold border-r border-app-line/15 dark:border-[#374151]" style={{ color: SETTINGS_ACCENT_COLOR }}>Cancel</button>
              <button onClick={commitIpSave} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold" style={{ color: 'var(--app-alert)' }}>Make Change</button>
            </div>
          </div>
        </div>
      )}
      ...
      {factoryResetPopup === 'confirm' && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">Warning: This will completely reset your Sami camera to factory defaults including erasing all recordings on the SD card. This cannot be undone. It WILL NOT affect the recordings already saved to your device.</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              <button onClick={() => setFactoryResetPopup(null)} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold border-r border-app-line/15 dark:border-[#374151]" style={{ color: SETTINGS_ACCENT_COLOR }}>Cancel</button>
              <button onClick={startFactoryReset} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold" style={{ color: 'var(--app-alert)' }}>Factory Reset</button>
            </div>
          </div>
        </div>
      )}
      ...
      {factoryResetPopup === 'done' && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">The camera has been reset and is restarting. You can un-plug it now or wait for it to finish restarting and re-add it.</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151]">
              <button onClick={completeFactoryReset} className="w-full text-lg py-4 hover:bg-app-sunken transition-colors font-semibold" style={{ color: SETTINGS_ACCENT_COLOR }}>Ok</button>
            </div>
          </div>
        </div>
      )}
      ...
      {rebootPopup === 'confirm' && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">This will restart your Sami camera. No settings will be affected.</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              <button onClick={() => setRebootPopup(null)} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold border-r border-app-line/15 dark:border-[#374151]" style={{ color: SETTINGS_ACCENT_COLOR }}>Cancel</button>
              <button onClick={startReboot} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold" style={{ color: 'var(--app-alert)' }}>Reboot</button>
            </div>
          </div>
        </div>
      )}
      ...
      {rebooting && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[480px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold text-center">Rebooting...</h2>
            </div>
      ...
      {rebootPopup === 'done' && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">The camera has been rebooted and is restarting.</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151]">
              <button
                onClick={() => { setRebootPopup(null); setShowCameraSettings(false); }}
                className="w-full text-lg py-4 hover:bg-app-sunken transition-colors font-semibold"
                style={{ color: SETTINGS_ACCENT_COLOR }}
              >Ok</button>
            </div>
          </div>
      ...
      {sdPopup === 'confirm-format' && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">Warning: this will reformat and erase the SD card on your camera. This cannot be undone. It WILL NOT affect the recordings already saved to your device.</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              <button onClick={() => setSdPopup(null)} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold border-r border-app-line/15 dark:border-[#374151]" style={{ color: SETTINGS_ACCENT_COLOR }}>Cancel</button>
              <button onClick={startFormat} className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold" style={{ color: 'var(--app-alert)' }}>Format SD</button>
            </div>
          </div>
        </div>
      )}
      ...
      {sdFormatting && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[480px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold text-center">Formatting...</h2>
            </div>
            <div className="px-8 py-6 flex flex-col items-center gap-4">
              <div className="w-24 h-24 bg-app-card rounded-full flex items-center justify-center border-2 border-app-quiet">
                <Loader2 className="w-12 h-12 text-app-quiet animate-spin" />
      ...
      {sdPopup === 'format-failed' && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2"><h2 className="text-app-content text-xl font-semibold text-center">Format failed!</h2></div>
            <div className="px-8 py-5"><p className="text-app-content-soft text-base leading-relaxed text-center">The microSD card is either missing or bad.</p></div>
            <div className="border-t border-app-line/15 dark:border-[#374151]"><button onClick={() => setSdPopup(null)} className="w-full text-lg py-4 hover:bg-app-sunken transition-colors font-semibold" style={{ color: SETTINGS_ACCENT_COLOR }}>Ok</button></div>
          </div>
        </div>
      )}
      ...
      {sdPopup === 'format-complete' && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2"><h2 className="text-app-content text-xl font-semibold text-center">Format complete!</h2></div>
            <div className="border-t border-app-line/15 dark:border-[#374151] mt-4"><button onClick={() => setSdPopup(null)} className="w-full text-lg py-4 hover:bg-app-sunken transition-colors font-semibold" style={{ color: SETTINGS_ACCENT_COLOR }}>Ok</button></div>
          </div>
        </div>
      )}
      ...
      {recordThresholdError && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold text-center">Save Failed</h2>
            </div>
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">
            ...
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              <button
                ...
                className="flex-1 text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold"
                style={{ color: SETTINGS_ACCENT_COLOR }}
              >
                OK
              </button>
      ...
      {rmPopup && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold text-center">{rmPopup.title}</h2>
            </div>
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">{rmPopup.message}</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              {rmPopup.hasCancel && (
                <button
      ...
      {nvPopup && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold text-center">{nvPopup.title}</h2>
            </div>
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">{nvPopup.message}</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              {nvPopup.hasCancel && (
                <button
      ...
      {irPopup && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold text-center">{irPopup.title}</h2>
            </div>
            <div className="px-8 py-5">
              <p className="text-app-content-soft text-base leading-relaxed text-center">{irPopup.message}</p>
            </div>
            <div className="border-t border-app-line/15 dark:border-[#374151] flex">
              {irPopup.hasCancel && (
                <button
      ...
      {showCameraWifiPicker && (
        <div className="absolute inset-0 bg-black/70 z-40 flex items-center justify-center">
          ...
          {cameraWifiPickerStep === 'select' && (
            <div className="bg-app-card rounded-2xl w-[480px] overflow-hidden border border-app-line/15 dark:border-[#374151] shadow-2xl">
              <div className="p-6 border-b border-app-line/15 dark:border-[#374151] flex items-start justify-between">
                <div>
                  <h2 className="text-2xl text-app-content">Select Camera Wi-Fi</h2>
                ...
                {cwPickerIsRefreshing ? (
                  ...
                  return (
                    <button key={network.ssid} onClick={() => setCwPickerSelectedSsid(network.ssid)}
                      className={`w-full flex items-center gap-3 px-4 py-3 transition-colors ${isSelected ? 'bg-app-sunken' : 'hover:bg-app-sunken'}`}
                    >
                      <Wifi className={`w-5 h-5 flex-shrink-0 ${network.strength === 3 ? 'text-app-content' : network.strength === 2 ? 'text-app-content-faint' : 'text-app-content-faint'}`} />
                      ...
                      {isSelected
                        ...
                        : network.secured && <Lock className="w-4 h-4 flex-shrink-0 text-app-content-faint" />
                      }
                    </button>
                  );
                })}
          ...
          {cameraWifiPickerStep === 'password' && (
            <div className="bg-app-card rounded-2xl w-[480px] overflow-hidden border border-app-line/15 dark:border-[#374151] shadow-2xl p-8">
              <div className="flex items-center justify-center gap-3 mb-6">
                ...
                <h2 className="text-xl text-center text-app-content">{cameraWifiPendingSsid}</h2>
              </div>
              ...
              <div className="mb-6">
                <label className="block text-sm mb-2 text-app-content-faint">Wi-Fi Password</label>
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-xl pr-12 focus:outline-none bg-app-surface text-app-content placeholder-gray-600 ${cwPickerPwError ? 'border-[#B85555]' : 'border-app-line/20 dark:border-[#4b5563] focus:border-[#5A8BBF]'}`}
                    placeholder="Enter password"
                    autoFocus
                  />
                  <button onClick={() => setCwPickerShowPw(v => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 p-2 hover:bg-app-sunken rounded-lg" type="button">
                    {cwPickerShowPw ? <EyeOff className="w-5 h-5 text-app-content-faint" /> : <Eye className="w-5 h-5 text-app-content-faint" />}
                  </button>
                </div>
              </div>
            ...
            <div className="bg-app-card rounded-2xl w-[480px] overflow-hidden border border-app-line/15 dark:border-[#374151] shadow-2xl">
              ...
              <div className="border-t border-app-line/15 dark:border-[#374151] flex flex-col">
                <button
                  ...
                  className="w-full text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold border-b border-app-line/15 dark:border-[#374151]"
                  style={{ color: SETTINGS_ACCENT_COLOR }}
                >Continue</button>
                {!cameraWifiPendingIsOpen && (
                ...
                <button
                  onClick={() => { setShowCameraWifiPicker(false); setCameraWifiPickerStep('select'); }}
                  className="w-full text-lg py-4 hover:bg-app-sunken transition-colors text-center font-semibold text-[#B95555]"
                >Cancel</button>
              </div>
            </div>
          )}
          ...
          {cameraWifiPickerStep === 'testing' && (
            <div className="bg-app-card rounded-lg w-[480px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
              <div className="px-8 pt-6 pb-4 border-b border-app-line/15 dark:border-[#374151]">
                <h2 className="text-app-content text-xl font-semibold text-center">Connecting Camera to Wi-Fi</h2>
              </div>
      ...
      {showCameraWifiSuccess && (
        <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
            <div className="px-8 pt-6 pb-2">
              <h2 className="text-app-content text-xl font-semibold">Wi-Fi configured.</h2>
            </div>
            <div className="px-8 py-5">
          ...
          <div className="absolute inset-0 bg-black/70 z-50 flex items-center justify-center">
            <div className="bg-app-card rounded-lg w-[520px] overflow-hidden border border-app-line/15 dark:border-[#374151]">
              ...
              <div className="flex flex-col items-center pt-8 pb-2 px-8">
                ...
                <h2 className="text-app-content text-xl font-semibold text-center mb-2">Edit Camera Password</h2>
                <p className="text-app-content-faint text-sm text-center">Password must contain a capital letter, at least 4 letters and 2 numbers</p>
              </div>
              ...
              <div className="px-8 py-5 space-y-4">
                <div>
                  ...
                  <div className="space-y-3">
                    <input
                      ...
                      autoFocus
                      className={`w-full px-4 py-3 border rounded-xl focus:outline-none bg-app-surface text-app-content placeholder-gray-500 ${editPasswordError ? 'border-app-alert focus:border-app-alert' : 'border-app-amber/30 focus:border-app-amber'}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength={30}
                    className="w-full px-4 py-3 border border-app-amber/30 rounded-xl focus:outline-none focus:border-app-amber bg-app-surface text-app-content placeholder-gray-500"
                    placeholder="Password hint (e.g., my first pet's name)"
                  />
                  <p className="text-xs text-app-content-faint mt-1 text-left">This will help you remember your password ({editedPasswordHint.length}/30)</p>
                </div>
                {editPasswordError && (
                  <p className="text-sm text-app-alert">{editPasswordError}</p>
                )}
              </div>
